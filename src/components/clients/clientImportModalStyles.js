...
export const boxF14White = { background: "var(--card)", border: "1px solid var(--border)", color: "var(--heading)", width: 32, height: 32, borderRadius: 8, cursor: "pointer", fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center", padding: 0 };
