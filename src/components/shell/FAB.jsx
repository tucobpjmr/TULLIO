...
export const FAB = ({ onClick }) => {
  ...
  <button onClick={onClick} style={{
    ...
    {...conTastiera(
      e => { e.currentTarget.style.transform = "scale(1.1)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(212,168,67,0.6)"; },
      e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(212,168,67,0.5)"; },
    )}
  >+</button>
  );
};
