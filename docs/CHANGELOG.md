...
## v2.5-dev — Chat busy/online + Preferenze UI (dark mode) + Template messaggi (sessione 24)
...
```
dist/assets/index-*.js     272.82 kB │ gzip: 65.74 kB   (+2.22 kB gz vs v2.4 sessione 23)
