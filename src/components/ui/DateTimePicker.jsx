...
export function DateTimePicker({ value, onChange, hasError = false, style = /** @type {object|undefined} */ (undefined), placeholder = "gg/mm/aaaa --:--", align = "left", withTime = true, ariaLabel }) {
