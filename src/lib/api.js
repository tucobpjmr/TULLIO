...
// Il tag `origin_client` che ogni mutation su una tabella live porta con sé sta
// con il codice che lo LEGGE per scartare l'eco: le due metà di quel contratto
// erano ai due capi di questo file, ora sono contigue in lib/realtime.js.
