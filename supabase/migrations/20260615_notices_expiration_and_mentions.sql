...
--
-- STATO: applicato via apply_migration MCP il 15/6/2026; questo file e' per
--        version control (stesso pattern di 20260614_dossier_notifications.sql
--        e 20260614_mention_composite_names.sql).
--
...
--
-- Pattern identico alle notifiche task/pratica: nascono SOLO da trigger
-- server-side (RLS vieta l'insert dal client). SECURITY DEFINER per
-- bypassare la policy "own notifications".
