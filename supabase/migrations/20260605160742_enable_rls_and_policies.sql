...
-- USERS
-- ============================================================
-- Tutti gli utenti autenticati possono leggere la rubrica team
...
-- Solo admin può inserire/eliminare utenti, e modificare ruoli altrui
...
-- TASKS
-- ============================================================
-- Admin/Manager vedono tutto; Agent/Driver solo i propri (assegnati o creati)
...
-- Tutti gli autenticati possono creare task (created_by = sé stessi)
CREATE POLICY tasks_insert ON public.tasks
  FOR INSERT TO authenticated
  WITH CHECK (created_by = auth.uid());

-- Admin/Manager modificano qualunque task; assegnatari il proprio
...
-- COMMENTS
-- ============================================================
-- Leggi commenti dei task che puoi vedere
...
-- Inserisci commenti come sé stesso
CREATE POLICY comments_insert ON public.comments
  FOR INSERT TO authenticated
  WITH CHECK (user_id = auth.uid());

-- Modifica/elimina solo propri commenti (o admin)
